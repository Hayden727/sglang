...
def init_cp_strategy(server_args: "ServerArgs") -> None:
    """Bind the normalized CP strategy for this process."""
    global _STRATEGY
...
def _get_cp_strategy() -> Optional[ContextParallelStrategy]:
    """Return the normalized strategy, initializing lazily in worker processes."""
    global _STRATEGY
...
def cp_active(forward_batch: "ForwardBatch") -> bool:
    """True when CP-v2 is engaged for this forward pass."""
    return (
        get_cp_strategy() is not None
